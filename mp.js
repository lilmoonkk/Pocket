...
export default function mp() {
  ...
  return (
    ...
    <ScrollView style={[AddIncomeModalVisible ? {backgroundColor: 'rgba(0,0,0,0.5)'} : ''], {marginTop: 40}}>
      <Tab.Navigator>
      <Tab.Screen name="Home" component={ResetPassword} initialParams={{userid: userid}}/>
      <Tab.Screen name="Settings" component={ResetPassword} initialParams={{userid: userid}} />
    </Tab.Navigator>
